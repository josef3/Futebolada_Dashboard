    ...
    return (
        <>
            ...
            <ConfirmationDialog
                ...
                message={`Tens a certeza que pretendes eliminar ${selected.length} ${selected.length === 1 ? 'melhor 5' : 'melhores 5'}? Atenção: As alterações serão permanentes!`}
                type='warning'
            />
        </>
    );
